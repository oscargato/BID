...
export class FPermisoConstruccionPlanosComponent implements OnInit, AfterViewInit {
  ...
  getRevision(){
    this.fPermisoConstruccionPlanosService.getRevision(this.activatedRoute.snapshot.params.idRevision).subscribe(resp =>{
      console.log('idRevision',this.activatedRoute.snapshot.params.idRevision);
  ...
  fileDownloadIdoneo(){
    this.fPermisoConstruccionPlanosService.getDownloadFile(this.tramiteIdIdoneo,this.archivoIdoneo).subscribe(resp=>{
  ...
  fileDownloadPlanos(){
    this.fPermisoConstruccionPlanosService.getDownloadFile(this.tramiteIdPlanos,this.archivoPlanos).subscribe(resp=>{
